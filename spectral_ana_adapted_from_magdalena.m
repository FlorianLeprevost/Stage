...
LF_band = [0.04 0.15];
LF_HRV_but2 = ft_preproc_bandpassfilter(IBI_timeseries_resting.trial{1}, Fif_fs, LF_band, 2, 'but');
...
HF_band = [0.15 0.4];
HF_HRV_but2 = ft_preproc_bandpassfilter(IBI_timeseries_resting.trial{1}, Fif_fs, HF_band, 2, 'but');
